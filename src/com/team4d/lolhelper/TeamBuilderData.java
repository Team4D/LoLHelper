...
public class TeamBuilderData
{
	...
	private final ChampionAttributes[] allChampions;
	private final ChampionAttributes[] ourTeam;
	...
	public TeamBuilderData()
	{
		...
		int[] AzirAttributes = { 10, 10, 10, 20, 20, 20, 0, 0, 0, 20 };
		...
		allChampions[8] = (new ChampionAttributes("Azir", AzirAttributes, AzirPositions));
		allChampions[9] = (new ChampionAttributes("Blitzcrank", BlitzcrankAttributes, BlitzcrankPositions));
		allChampions[10] = (new ChampionAttributes("Brand", BrandAttributes, BrandPositions));
		...
		allChampions[18] = (new ChampionAttributes("Dr. Mundo", DrMundoAttributes, DrMundoPositions));
		allChampions[19] = (new ChampionAttributes("Draven", DravenAttributes, DravenPositions));
		allChampions[20] = (new ChampionAttributes("Elise", EliseAttributes, ElisePositions));
		allChampions[21] = (new ChampionAttributes("Evelynn", EvelynnAttributes, EvelynnPositions));
		allChampions[22] = (new ChampionAttributes("Ezreal", EzrealAttributes, EzrealPositions));
		allChampions[23] = (new ChampionAttributes("Fiddlesticks", FiddlesticksAttributes, FiddlesticksPositions));
		allChampions[24] = (new ChampionAttributes("Fiora", FioraAttributes, FioraPositions));
		allChampions[25] = (new ChampionAttributes("Fizz", FizzAttributes, FizzPositions));
		allChampions[26] = (new ChampionAttributes("Galio", GalioAttributes, GalioPositions));
		allChampions[27] = (new ChampionAttributes("Gangplank", GangplankAttributes, GangplankPositions));
		allChampions[28] = (new ChampionAttributes("Garen", GarenAttributes, GarenPositions));
		allChampions[29] = (new ChampionAttributes("Gnar", GnarAttributes, GnarPositions));
		allChampions[30] = (new ChampionAttributes("Gragas", GragasAttributes, GragasPositions));
		allChampions[31] = (new ChampionAttributes("Graves", GravesAttributes, GravesPositions));
		allChampions[32] = (new ChampionAttributes("Hecarim", HecarimAttributes, HecarimPositions));
		allChampions[33] = (new ChampionAttributes("Heimerdinger", HeimerdingerAttributes, HeimerdingerPositions));
		allChampions[34] = (new ChampionAttributes("Irelia", IreliaAttributes, IreliaPositions));
		allChampions[35] = (new ChampionAttributes("Janna", JannaAttributes, JannaPositions));
		allChampions[36] = (new ChampionAttributes("Jarvan IV", JarvanIVAttributes, JarvanIVPositions));
		allChampions[37] = (new ChampionAttributes("Jax", JaxAttributes, JaxPositions));
		allChampions[38] = (new ChampionAttributes("Jayce", JayceAttributes, JaycePositions));
		allChampions[39] = (new ChampionAttributes("Jinx", JinxAttributes, JinxPositions));
		allChampions[40] = (new ChampionAttributes("Karma", KarmaAttributes, KarmaPositions));
		allChampions[41] = (new ChampionAttributes("Karthus", KarthusAttributes, KarthusPositions));
		allChampions[42] = (new ChampionAttributes("Kassadin", KassadinAttributes, KassadinPositions));
		...
		allChampions[51] = (new ChampionAttributes("Lissandra", LissandraAttributes, LissandraPositions));
		allChampions[52] = (new ChampionAttributes("Lucian", LucianAttributes, LucianPositions));
		allChampions[53] = (new ChampionAttributes("Lulu", LuluAttributes, LuluPositions));
		allChampions[54] = (new ChampionAttributes("Lux", LuxAttributes, LuxPositions));
		allChampions[55] = (new ChampionAttributes("Malphite", MalphiteAttributes, MalphitePositions));
		allChampions[56] = (new ChampionAttributes("Malzahar", MalzaharAttributes, MalzaharPositions));
		allChampions[57] = (new ChampionAttributes("Maokai", MaokaiAttributes, MaokaiPositions));
		allChampions[58] = (new ChampionAttributes("Master Yi", MasterYiAttributes, MasterYiPositions));
		allChampions[59] = (new ChampionAttributes("Miss Fortune", MissFortuneAttributes, MissFortunePositions));
		allChampions[60] = (new ChampionAttributes("Mordekaiser", MordekaiserAttributes, MordekaiserPositions));
		allChampions[61] = (new ChampionAttributes("Morgana", MorganaAttributes, MorganaPositions));
		allChampions[62] = (new ChampionAttributes("Nami", NamiAttributes, NamiPositions));
		allChampions[63] = (new ChampionAttributes("Nasus", NasusAttributes, NasusPositions));
		allChampions[64] = (new ChampionAttributes("Nautilus", NautilusAttributes, NautilusPositions));
		allChampions[65] = (new ChampionAttributes("Nidalee", NidaleeAttributes, NidaleePositions));
		allChampions[66] = (new ChampionAttributes("Nocturne", NocturneAttributes, NocturnePositions));
		allChampions[67] = (new ChampionAttributes("Nunu", NunuAttributes, NunuPositions));
		allChampions[68] = (new ChampionAttributes("Olaf", OlafAttributes, OlafPositions));
		allChampions[69] = (new ChampionAttributes("Orianna", OriannaAttributes, OriannaPositions));
		allChampions[70] = (new ChampionAttributes("Pantheon", PantheonAttributes, PantheonPositions));
		allChampions[71] = (new ChampionAttributes("Poppy", PoppyAttributes, PoppyPositions));
		allChampions[72] = (new ChampionAttributes("Quinn", QuinnAttributes, QuinnPositions));
		allChampions[73] = (new ChampionAttributes("Rammus", RammusAttributes, RammusPositions));
		allChampions[74] = (new ChampionAttributes("Renekton", RenektonAttributes, RenektonPositions));
		allChampions[75] = (new ChampionAttributes("Rengar", RengarAttributes, RengarPositions));
		allChampions[76] = (new ChampionAttributes("Riven", RivenAttributes, RivenPositions));
		allChampions[77] = (new ChampionAttributes("Rumble", RumbleAttributes, RumblePositions));
		allChampions[78] = (new ChampionAttributes("Ryze", RyzeAttributes, RyzePositions));
		allChampions[79] = (new ChampionAttributes("Sejuani", SejuaniAttributes, SejuaniPositions));
		allChampions[80] = (new ChampionAttributes("Shaco", ShacoAttributes, ShacoPositions));
		allChampions[81] = (new ChampionAttributes("Shen", ShenAttributes, ShenPositions));
		allChampions[82] = (new ChampionAttributes("Shyvana", ShyvanaAttributes, ShyvanaPositions));
		allChampions[83] = (new ChampionAttributes("Singed", SingedAttributes, SingedPositions));
		allChampions[84] = (new ChampionAttributes("Sion", SionAttributes, SionPositions));
		allChampions[85] = (new ChampionAttributes("Sivir", SivirAttributes, SivirPositions));
		allChampions[86] = (new ChampionAttributes("Skarner", SkarnerAttributes, SkarnerPositions));
		allChampions[87] = (new ChampionAttributes("Sona", SonaAttributes, SonaPositions));
		allChampions[88] = (new ChampionAttributes("Soraka", SorakaAttributes, SorakaPositions));
		allChampions[89] = (new ChampionAttributes("Swain", SwainAttributes, SwainPositions));
		allChampions[90] = (new ChampionAttributes("Syndra", SyndraAttributes, SyndraPositions));
		allChampions[91] = (new ChampionAttributes("Talon", TalonAttributes, TalonPositions));
		allChampions[92] = (new ChampionAttributes("Taric", TaricAttributes, TaricPositions));
		allChampions[93] = (new ChampionAttributes("Teemo", TeemoAttributes, TeemoPositions));
		allChampions[94] = (new ChampionAttributes("Thresh", ThreshAttributes, ThreshPositions));
		allChampions[95] = (new ChampionAttributes("Tristana", TristanaAttributes, TristanaPositions));
		allChampions[96] = (new ChampionAttributes("Trundle", TrundleAttributes, TrundlePositions));
		allChampions[97] = (new ChampionAttributes("Tryndamere", TryndamereAttributes, TryndamerePositions));
		allChampions[98] = (new ChampionAttributes("Twisted Fate", TwistedFateAttributes, TwistedFatePositions));
		allChampions[99] = (new ChampionAttributes("Twitch", TwitchAttributes, TwitchPositions));
		allChampions[100] = (new ChampionAttributes("Udyr", UdyrAttributes, UdyrPositions));
		allChampions[101] = (new ChampionAttributes("Urgot", UrgotAttributes, UrgotPositions));
		...
		allChampions[109] = (new ChampionAttributes("Volibear", VolibearAttributes, VolibearPositions));
		allChampions[110] = (new ChampionAttributes("Warwick", WarwickAttributes, WarwickPositions));
		allChampions[111] = (new ChampionAttributes("Wukong", WukongAttributes, WukongPositions));
		allChampions[112] = (new ChampionAttributes("Xerath", XerathAttributes, XerathPositions));
		allChampions[113] = (new ChampionAttributes("Xin Zhao", XinZhaoAttributes, XinZhaoPositions));
		allChampions[114] = (new ChampionAttributes("Yasuo", YasuoAttributes, YasuoPositions));
		allChampions[115] = (new ChampionAttributes("Yorick", YorickAttributes, YorickPositions));
		allChampions[116] = (new ChampionAttributes("Zac", ZacAttributes, ZacPositions));
		allChampions[117] = (new ChampionAttributes("Zed", ZedAttributes, ZedPositions));
	...
	// Position is one of five positions in the team
