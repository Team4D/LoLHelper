...
public class BuildDatabase
{
	...
	private void buildtop()
	{
		 ...
		 * database[i][1].setSkillOrder(4, 1, 2, 3);
		 * numBuilds[i]++;
		 */
	...
	private void buildsupp()
	{
		...
		database[i][0].setAsNeeded("spiritvisage", "aegisofthelegion", "hexdrinker", "mawofmalmortius",
				"youmuusghostblade");
		...
		database[i][0].setAsNeeded("mikaelscrucible", "deathfiregrasp", "morellonomicon", "zhonyashourglass",
		...
		database[i][0].setAsNeeded("mikaelscrucible", "locketoftheironsolari", "talismanofascension", "randuinsomen",
				"spiritvisage");
		...
		database[i][0].setAsNeeded("rylaiscrystalscepter", "randuinsomen", "zhonyashourglass", "locketoftheironsolari",
				"talismanofascension");
		...
		database[i][0].setAsNeeded("athenesunholygrail", "rabadonsdeathcap", "zhonyashourglass", "abyssalscepter",
				"liandrystorment");
		...
		database[i][0].setAsNeeded("twinshadows", "sunfirecape", "iceborngauntlet", "locketoftheironsolari",
				"bansheesveil");
		...
		database[i][0].setAsNeeded("rabadonsdeathcap", "voidstaff", "randuinsomen", "liandrystorment",
		...
		database[i][0].setAsNeeded("randuinsomen", "locketoftheironsolari", "bansheesveil", "frozenheart",
				"mikaelscrucible");
		...
		database[i][0].setAsNeeded("abyssalscepter", "athenesunholygrail", "seraphsembrace", "rodofages",
				"zhonyashourglass");
		...
		database[i][0].setAsNeeded("locketoftheironsolari", "bansheesveil", "faceofthemountain", "warmogsarmor",
				"liandrystorment");
		...
		database[i][0].setAsNeeded("morellonomicon", "rylaiscrystalscepter", "mikaelscrucible",
				"locketoftheironsolari", "abyssalscepter");

		// Evelynn
		database[++i][0] = new BuildInfo();
		database[i][0].setStart("wardingtotem", "ancientcoin", "stealthward", "healthpotion");
		database[i][0].setRush("bootsofmobility", "frostqueensclaim", "rylaiscrystalscepter");
		database[i][0].setAsNeeded("catalysttheprotector", "rodofages", "abyssalscepter", "locketoftheironsolari",
				"talismanofascension");
		...
		database[i][0].setAsNeeded("locketoftheironsolari", "twinshadows", "spiritvisage", "abyssalscepter",
				"zhonyashourglass");
		...
		database[i][0].setAsNeeded("talismanofascension", "locketoftheironsolari", "atmasimpaler", "frozenmallet",
				"warmogsarmor");
		...
		database[i][0].setAsNeeded("abyssalscepter", "morellonomicon", "rabadonsdeathcap", "rylaiscrystalscepter",
				"zhonyashourglass");
		...
		database[i][0].setAsNeeded("locketoftheironsolari", "faceofthemountain", "randuinsomen", "iceborngauntlet",
				"zekesherald");
		...
		database[i][0].setAsNeeded("locketoftheironsolari", "zekesherald", "talismanofascension", "theblackcleaver",
				"randuinsomen");
		...
		database[i][0].setStart("wardingtotem", "ancientcoin", "stealthward", "healthpotion");
		database[i][0].setRush("rubysightstone", "bootsofmobility", "talismanofascension");
		database[i][0].setAsNeeded("mikaelscrucible", "locketoftheironsolari", "liandrystorment", "rabadonsdeathcap",
				"morellonomicon");
		...
		database[i][0].setAsNeeded("randuinsomen", "locketoftheironsolari", "liandrystorment", "talismanofascension",
				"abyssalscepter");
		...
		database[i][0].setAsNeeded("sorcerersshoes", "talismanofascension", "rabadonsdeathcap", "zhonyashourglass",
				"morellonomicon");
		...
		database[i][0].setAsNeeded("talismanofascension", "faceofthemountain", "locketoftheironsolari", "frozenheart",
				"bansheesveil");
		...
		database[i][0].setAsNeeded("abyssalscepter", "guardianangel", "frozenheart", "liandrystorment",
				"deathfiregrasp");
		...
		database[i][0].setAsNeeded("lichbane", "morellonomicon", "locketoftheironsolari", "bansheesveil",
				"zhonyashourglass");
		...
		database[i][0].setAsNeeded("twinshadows", "zekesherald", "mikaelscrucible", "rabadonsdeathcap",
				"zhonyashourglass");
		...
		database[i][0].setAsNeeded("talismanofascension", "abyssalscepter", "randuinsomen", "locketoftheironsolari",
				"liandrystorment");
		...
		database[i][0].setAsNeeded("talismanofascension", "randuinsomen", "locketoftheironsolari", "iceborngauntlet",
				"athenesunholygrail");
		...
		database[i][0].setAsNeeded("frostqueensclaim", "rodofages", "liandrystorment", "rabadonsdeathcap",
				"abyssalscepter");
		...
		database[i][0].setAsNeeded("rabadonsdeathcap", "bannerofcommand", "voidstaff", "lichbane",
				"rylaiscrystalscepter");
		...
		database[i][0].setAsNeeded("locketoftheironsolari", "rylaiscrystalscepter", "liandrystorment", "twinshadows",
				"zhonyashourglass");
		...
		database[i][0].setAsNeeded("trinityforce", "hextechgunblade", "talismanofascension", "frozenheart",
		...
		database[i][0]
				.setAsNeeded("randuinsomen", "thornmail", "locketoftheironsolari", "spiritvisage", "warmogsarmor");
		...
		database[i][0].setAsNeeded("zhonyashourglass", "abyssalscepter", "randuinsomen", "rabadonsdeathcap",
				"liandrystorment");
		...
		database[i][0].setAsNeeded("frostqueensclaim", "zhonyashourglass", "rabadonsdeathcap", "mikaelscrucible",
				"lichbane");
		...
		database[i][0].setStart("wardingtotem", "relicshield", "stealthward", "healthpotion");
		database[i][0].setRush("rubysightstone", "mercurytreads", "faceofthemountain");
		database[i][0].setAsNeeded("locketoftheironsolari", "warmogsarmor", "spiritvisage", "randuinsomen",
				"bansheesveil");
		...
		database[i][0].setAsNeeded("talismanofascension", "lichbane", "iceborngauntlet", "abyssalscepter",
				"rylaiscrystalscepter");
		...
		database[i][0].setAsNeeded("locketoftheironsolari", "randuinsomen", "rabadonsdeathcap", "lichbane",
				"frozenheart");
		...
		database[i][0].setAsNeeded("mikaelscrucible", "randuinsomen", "rylaiscrystalscepter", "liandrystorment",
				"morellonomicon");
		...
		database[i][0].setAsNeeded("athenesunholygrail", "voidstaff", "liandrystorment", "locketoftheironsolari",
				"rylaiscrystalscepter");
		...
		database[i][0].setAsNeeded("spiritvisage", "randuinsomen", "locketoftheironsolari", "theblackcleaver",
				"youmuusghostblade");
		...
		database[i][0].setAsNeeded("frozenheart", "faceofthemountain", "mikaelscrucible", "locketoftheironsolari",
				"talismanofascension");
		...
		database[i][0].setAsNeeded("voidstaff", "liandrystorment", "zhonyashourglass", "frostqueensclaim",
				"runaanshurricane");
		...
		database[i][0].setStart("wardingtotem", "ancientcoin", "stealthward", "healthpotion");
		database[i][0].setRush("rubysightstone", "bootsofmobility", "talismanofascension");
		database[i][0].setAsNeeded("locketoftheironsolari", "mikaelscrucible", "sunfirecape", "abyssalscepter",
				"randuinsomen");
		...
		database[i][0].setAsNeeded("iceborngauntlet", "frozenmallet", "randuinsomen", "warmogsarmor",
				"bladeoftheruinedking");
		...
		database[i][0].setAsNeeded("locketoftheironsolari", "faceofthemountain", "randuinsomen", "frozenmallet",
				"zekesherald");
		...
		database[i][0].setAsNeeded("talismanofascension", "iceborngauntlet", "locketoftheironsolari", "randuinsomen",
				"bansheesveil");
		...
		database[i][0].setAsNeeded("locketoftheironsolari", "frozenmallet", "zekesherald", "frozenheart",
				"mikaelscrucible");
		...
		database[i][0].setAsNeeded("voidstaff", "rabadonsdeathcap", "talismanofascension", "zhonyashourglass",
				"guardianangel");
		...
		database[i][0].setAsNeeded("frozenmallet", "spiritvisage", "sunfirecape", "talismanofascension",
				"locketoftheironsolari");
		...
		database[i][0].setAsNeeded("faceofthemountain", "warmogsarmor", "locketoftheironsolari", "abyssalscepter",
				"rylaiscrystalscepter");
		...
		database[i][0].setAsNeeded("athenesunholygrail", "rabadonsdeathcap", "rylaiscrystalscepter", "liandrystorment",
				"voidstaff");
	...
	private void buildjung()
	{
		...
		database[i][0].setStart("sweepinglens", "huntersmachete", "healthpotion");
		database[i][0].setRush("hextechgunblade", "sorcerersshoes", "zhonyashourglass");
		database[i][0].setAsNeeded("rabadonsdeathcap", "lichbane", "voidstaff", "rylaiscrystalscepter",
				"abyssalscepter");
		...
		database[i][0].setAsNeeded("liandrystorment", "rylaiscrystalscepter", "voidstaff", "zhonyashourglass",
				"lichbane");
		...
		database[i][0]
				.setAsNeeded("ravenoushydra", "randuinsomen", "trinityforce", "frozenmallet", "mercurialscimitar");
		...
		database[i][0].setAsNeeded("theblackcleaver", "thebloodthirster", "warmogsarmor", "iceborngauntlet",
				"trinityforce");
		...
		database[i][0]
				.setAsNeeded("thebloodthirster", "trinityforce", "infinityedge", "phantomdancer", "guardianangel");
		...
		database[i][0]
				.setAsNeeded("sunfirecape", "spiritvisage", "randuinsomen", "rylaiscrystalscepter", "frozenheart");
		...
		database[i][0].setAsNeeded("randuinsomen", "bladeoftheruinedking", "thebloodthirster", "spiritvisage",
				"warmogsarmor");
		...
		database[i][0]
				.setAsNeeded("liandrystorment", "voidstaff", "randuinsomen", "bansheesveil", "athenesunholygrail");

		// Graves
		database[++i][0] = new BuildInfo();
		database[i][0].setStart("sweepinglens", "huntersmachete", "healthpotion");
		database[i][0].setRush("wriggleslantern", "thebloodthirster", "berserkergreaves", "bladeoftheruinedking");
		database[i][0].setAsNeeded("frozenmallet", "runaanshurricane", "infinityedge", "phantomdancer",
				"theblackcleaver");
		...
		database[i][0]
				.setAsNeeded("athenesunholygrail", "zhonyashourglass", "rabadonsdeathcap", "rylaiscrystalscepter");

		// Karthus
		database[++i][0] = new BuildInfo();
		database[i][0].setStart("wardingtotem", "huntersmachete", "healthpotion");
		database[i][0].setRush("spiritofthespectralwraith", "sorcerersshoes", "rodofages", "zhonyashourglass");
		database[i][0].setAsNeeded("voidstaff", "rabadonsdeathcap", "rylaiscrystalscepter", "deathfiregrasp",
				"liandrystorment");
		...
		database[i][0].setAsNeeded("lastwhisper", "theblackcleaver", "rubysightstone", "randuinsomen",
				"locketoftheironsolari");
		...
		database[i][0].setAsNeeded("iceborngauntlet", "trinityforce", "mawofmalmortius", "randuinsomen",
				"wriggleslantern");
		...
		database[i][0].setAsNeeded("rodofages", "rabadonsdeathcap", "liandrystorment", "zhonyashourglass",
				"rylaiscrystalscepter");
		...
		database[i][0].setAsNeeded("rylaiscrystalscepter", "spiritvisage", "rodofages", "deathfiregrasp",
				"liandrystorment");
		...
		database[i][0].setStart("sweepinglens", "huntersmachete", "healthpotion");
		database[i][0].setRush("spiritofthespectralwraith", "sorcerersshoes", "zhonyashourglass");
		database[i][0].setAsNeeded("abyssalscepter", "rabadonsdeathcap", "liandrystorment", "randuinsomen",
				"rylaiscrystalscepter");
		...
		database[i][0].setAsNeeded("athenesunholygrail", "abyssalscepter", "zhonyashourglass", "randuinsomen",
				"iceborngauntlet");
		...
		database[i][0].setAsNeeded("spiritvisage", "sunfirecape", "guardianangel", "locketoftheironsolari",
				"frozenheart");
		...
		database[i][0].setAsNeeded("sunfirecape", "randuinsomen", "locketoftheironsolari", "trinityforce",
				"spiritvisage");
		...
		database[i][0].setAsNeeded("spiritofthespectralwraith", "rabadonsdeathcap", "zhonyashourglass",
				"liandrystorment", "voidstaff");

		// Talon
		database[++i][0] = new BuildInfo();
		database[i][0].setStart("sweepinglens", "huntersmachete", "healthpotion");
		database[i][0].setRush("spiritoftheelderlizard", "bootsofmobility", "tearofthegoddess", "vampiricscepter");
		database[i][0].setAsNeeded("ravenoushydra", "theblackcleaver", "thebloodthirster", "spiritvisage",
				"lastwhisper");
		...
		database[i][0].setAsNeeded("bilgewatercutlass", "hextechgunblade", "zhonyashourglass", "frozenheart",
				"locketoftheironsolari");
		...
		database[i][0].setStart("sweepinglens", "huntersmachete", "healthpotion");
		database[i][0]
				.setRush("mercurytreads", "spiritofthespectralwraith", "rylaiscrystalscepter", "zhonyashourglass");
