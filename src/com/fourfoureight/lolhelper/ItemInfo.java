...
import com.fourfoureight.lolhelper.Build_Guides.BuildGuides;
		...
		//
	             ...
	             message = message.replaceAll("[^a-zA-Z]+","").toLowerCase();
	     			...
	     			if(message.equals("abyssalscepter")){
	            		...
	            		i = 79;
	            	}else if(message.equals("kitaesbloodrazor")){ //inaccessible
	            		i = 80;
	            		...
	            		i = 87;
	            	}else if(message.equals("manamanipulator")){ //inaccessible
	            		i = 88;
