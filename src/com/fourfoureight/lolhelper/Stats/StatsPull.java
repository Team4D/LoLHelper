...
public class StatsPull
{
	...
	private final String apikey = "?api_key=f685bd80-568e-4ff3-9d20-4bde13ab7106";

	// ---===== Player Statistics data =====---
	// Wins
	private long rankedPremade3x3Wins, rankedPremade5x5Wins, rankedSolo5x5Losses, rankedTeam3x3Wins, rankedTeam5x5Wins,
			rankedSolo5x5Wins;
	...
	// Dominion Stats
	private long domWins, domChampKills, domAssists, domMostKills, domMostAssists, domHighestScore, domNodesCaptured,
			domMostNodesCaptured, domNodesNeutralized, domMostNodesNeutralized;
	// Booleans for have played game modes
	private boolean hasPlayedRanked5v5 = false, hasPlayedNormal5v5 = false, hasPlayedDominion = false,
			hasPlayedNormal3v3 = false, hasPlayedofa = false, hasPlayedfb1 = false, hasPlayedfb2 = false,
			hasPlayedhex = false, hasPlayedurf = false;
	...
	{
		String statsrequest = "https://na.api.pvp.net/api/lol/na/v1.3/stats/by-summoner/" + summonerID + "/summary"
				+ apikey;
	...
	private void statsExtract() throws JSONException
	{
		...
		try
		{
			if ((summonerStats.hasSummary("Unranked")) && (summonerStats.getSummary("Unranked").hasAggregatedStats()))
			{
				...
				this.nNeutralMonsterKills = summonerStats.getSummary("Unranked").getAggregatedStat(
		...
		try
		{
			if ((summonerStats.hasSummary("RankedSolo5x5"))
					&& (summonerStats.getSummary("RankedSolo5x5").hasAggregatedStats()))
			{
				...
				this.rNeutralMonsterKills = summonerStats.getSummary("RankedSolo5x5").getAggregatedStat(
						"totalNeutralMinionsKilled");
				this.rTotalTurretKills = summonerStats.getSummary("RankedSolo5x5").getAggregatedStat(
						"totalTurretsKilled");
		...
		try
		{
			if ((summonerStats.hasSummary("OdinUnranked"))
					&& (summonerStats.getSummary("OdinUnranked").hasAggregatedStats()))
			{
				...
				this.domHighestScore = summonerStats.getSummary("OdinUnranked")
						.getAggregatedStat("maxTotalPlayerScore");
				...
				this.domMostNodesCaptured = summonerStats.getSummary("OdinUnranked")
						.getAggregatedStat("maxNodeCapture");
				this.domMostNodesNeutralized = summonerStats.getSummary("OdinUnranked").getAggregatedStat(
						"maxNodeNeutralize");
				this.domNodesCaptured = summonerStats.getSummary("OdinUnranked").getAggregatedStat("totalNodeCapture");
				this.domNodesNeutralized = summonerStats.getSummary("OdinUnranked").getAggregatedStat(
						"totalNodeNeutralize");
			}
		} catch (JSONException e)
		{
		...
		try
		{
			if ((summonerStats.hasSummary("Unranked3x3"))
					&& (summonerStats.getSummary("Unranked3x3").hasAggregatedStats()))
			{
				...
				this.tvtNeutralMonsterKills = summonerStats.getSummary("Unranked3x3").getAggregatedStat(
						"totalNeutralMinionsKilled");
				this.tvtTotalTurretKills = summonerStats.getSummary("Unranked3x3").getAggregatedStat(
						"totalTurretsKilled");
			}
		} catch (JSONException e)
		{
		...
		try
		{
			if ((summonerStats.hasSummary("OneForAll5x5"))
					&& (summonerStats.getSummary("OneForAll5x5").hasAggregatedStats()))
			{
				...
				this.ofaNeutralMonsterKills = summonerStats.getSummary("OneForAll5x5").getAggregatedStat(
						"totalNeutralMinionsKilled");
				this.ofaTotalTurretKills = summonerStats.getSummary("OneForAll5x5").getAggregatedStat(
						"totalTurretsKilled");
			}
		} catch (JSONException e)
		{
		...
		try
		{
			if ((summonerStats.hasSummary("FirstBlood1x1"))
					&& (summonerStats.getSummary("FirstBlood1x1").hasAggregatedStats()))
			{
				...
				this.fb1NeutralMonsterKills = summonerStats.getSummary("FirstBlood1x1").getAggregatedStat(
						"totalNeutralMinionsKilled");
				this.fb1TotalTurretKills = summonerStats.getSummary("FirstBlood1x1").getAggregatedStat(
						"totalTurretsKilled");
			}
		} catch (JSONException e)
		{
		...
		try
		{
			if ((summonerStats.hasSummary("FirstBlood2x2"))
					&& (summonerStats.getSummary("FirstBlood2x2").hasAggregatedStats()))
			{
				...
				this.fb2NeutralMonsterKills = summonerStats.getSummary("FirstBlood2x2").getAggregatedStat(
						"totalNeutralMinionsKilled");
				this.fb2TotalTurretKills = summonerStats.getSummary("FirstBlood2x2").getAggregatedStat(
						"totalTurretsKilled");
			}
		} catch (JSONException e)
		{
		...
		try
		{
			if ((summonerStats.hasSummary("SummonersRift6x6"))
					&& (summonerStats.getSummary("SummonersRift6x6").hasAggregatedStats()))
			{
				...
				this.hexChampKills = summonerStats.getSummary("SummonersRift6x6").getAggregatedStat(
						"totalChampionKills");
				this.hexMinionKills = summonerStats.getSummary("SummonersRift6x6")
						.getAggregatedStat("totalMinionKills");
				this.hexNeutralMonsterKills = summonerStats.getSummary("SummonersRift6x6").getAggregatedStat(
						"totalNeutralMinionsKilled");
				this.hexTotalTurretKills = summonerStats.getSummary("SummonersRift6x6").getAggregatedStat(
						"totalTurretsKilled");
			}
		} catch (JSONException e)
		{
		...
		try
		{
			if ((summonerStats.hasSummary("URF")) && (summonerStats.getSummary("URF").hasAggregatedStats()))
			{
				...
				this.urfNeutralMonsterKills = summonerStats.getSummary("URF").getAggregatedStat(
						"totalNeutralMinionsKilled");
