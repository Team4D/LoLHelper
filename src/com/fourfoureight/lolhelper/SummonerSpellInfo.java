...
public class SummonerSpellInfo extends ActionBarActivity {
     ...
     protected void onCreate(Bundle savedInstanceState) {
             ...
             switch(i){
  			case 0: icon.setImageResource(R.drawable.barrier);
  					break;
  			case 1: icon.setImageResource(R.drawable.clairvoyance);
						break;
  			case 2: icon.setImageResource(R.drawable.clarity);
						break;
  			case 3: icon.setImageResource(R.drawable.cleanse);
						break;
  			case 4: icon.setImageResource(R.drawable.exhaust);
  					break;
  			case 5: icon.setImageResource(R.drawable.flash);
  					break;
  			case 6: icon.setImageResource(R.drawable.garrison);
  					break;
  			case 7: icon.setImageResource(R.drawable.ghost);
  					break;
  			case 8: icon.setImageResource(R.drawable.heal);
  					break;
  			case 9: icon.setImageResource(R.drawable.ignite);
  					break;
  			case 10: icon.setImageResource(R.drawable.revive);
  					break;
  			case 11: icon.setImageResource(R.drawable.smite);
  					break;
  			case 12: icon.setImageResource(R.drawable.teleport);
  					break;
				default: break;
  			}
