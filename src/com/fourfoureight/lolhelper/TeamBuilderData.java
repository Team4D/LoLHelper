...
//==============================================================================
	...
	public TeamBuilderData(){
		...
		allChampions[10] = (new ChampionAttributes("Caitlyn", CaitlynAttributes, CaitlynPositions));
		allChampions[11] = (new ChampionAttributes("Cassiopeia", CassiopeiaAttributes, CassiopeiaPositions));
		allChampions[12] = (new ChampionAttributes("Cho Gath", ChoGathAttributes, ChoGathPositions));
		allChampions[13] = (new ChampionAttributes("Corki", CorikiAttributes, CorikiPositions));
		allChampions[14] = (new ChampionAttributes("Darius", DariusAttributes, DariusPositions));
		allChampions[15] = (new ChampionAttributes("Diana", DianaAttributes, DianaPositions));
		allChampions[16] = (new ChampionAttributes("Dr. Mundo", DrMundoAttributes, DrMundoPositions));
		allChampions[17] = (new ChampionAttributes("Draven", DravenAttributes, DravenPositions));
		allChampions[18] = (new ChampionAttributes("Elise", EliseAttributes, ElisePositions));
		allChampions[19] = (new ChampionAttributes("Evelynn", EvelynnAttributes, EvelynnPositions));
		allChampions[20] = (new ChampionAttributes("Ezreal", EzrealAttributes, EzrealPositions));
		allChampions[21] = (new ChampionAttributes("Fiddlesticks", FiddlesticksAttributes, FiddlesticksPositions));
		allChampions[22] = (new ChampionAttributes("Fiora", FioraAttributes, FioraPositions));
		allChampions[23] = (new ChampionAttributes("Fizz", FizzAttributes, FizzPositions));
		allChampions[24] = (new ChampionAttributes("Galio", GalioAttributes, GalioPositions));
		allChampions[25] = (new ChampionAttributes("Gangplank", GangplankAttributes, GangplankPositions));
		allChampions[26] = (new ChampionAttributes("Garen", GarenAttributes, GarenPositions));
		allChampions[27] = (new ChampionAttributes("Gragas", GragasAttributes, GragasPositions));
		allChampions[28] = (new ChampionAttributes("Graves", GravesAttributes, GravesPositions));
		allChampions[29] = (new ChampionAttributes("Hecarim", HecarimAttributes, HecarimPositions));
		allChampions[30] = (new ChampionAttributes("Heimerdinger", HeimerdingerAttributes, HeimerdingerPositions));
		allChampions[31] = (new ChampionAttributes("Irelia", IreliaAttributes, IreliaPositions));
		allChampions[32] = (new ChampionAttributes("Janna", JannaAttributes, JannaPositions));
		allChampions[33] = (new ChampionAttributes("Jarvan IV", JarvanIVAttributes, JarvanIVPositions));
		allChampions[34] = (new ChampionAttributes("Jax", JaxAttributes, JaxPositions));
		allChampions[35] = (new ChampionAttributes("Jayce", JayceAttributes, JaycePositions));
		allChampions[36] = (new ChampionAttributes("Jinx", JinxAttributes, JinxPositions));
		allChampions[37] = (new ChampionAttributes("Karma", KarmaAttributes, KarmaPositions));
		allChampions[38] = (new ChampionAttributes("Karthus", KarthusAttributes, KarthusPositions));
		allChampions[39] = (new ChampionAttributes("Kassadin", KassadinAttributes, KassadinPositions));
		allChampions[40] = (new ChampionAttributes("Katarina", KatarinaAttributes, KatarinaPositions));
		allChampions[41] = (new ChampionAttributes("Kayle", KayleAttributes, KaylePositions));
		allChampions[42] = (new ChampionAttributes("Kennen", KennenAttributes, KennenPositions));
		allChampions[43] = (new ChampionAttributes("Kha Zix", KhaZixAttributes, KhaZixPositions));
		allChampions[44] = (new ChampionAttributes("Kog Maw", KogMawAttributes, KogMawPositions));
		allChampions[45] = (new ChampionAttributes("LeBlanc", LeBlancAttributes, LeBlancPositions));
		allChampions[46] = (new ChampionAttributes("Lee Sin", LeeSinAttributes, LeeSinPositions));
		allChampions[47] = (new ChampionAttributes("Leona", LeonaAttributes, LeonaPositions));
		allChampions[48] = (new ChampionAttributes("Lissandra", LissandraAttributes, LissandraPositions));
		allChampions[49] = (new ChampionAttributes("Lucian", LucianAttributes, LucianPositions));
		allChampions[50] = (new ChampionAttributes("Lulu", LuluAttributes, LuluPositions));
		allChampions[51] = (new ChampionAttributes("Lux", LuxAttributes, LuxPositions));
		allChampions[52] = (new ChampionAttributes("Malphite", MalphiteAttributes, MalphitePositions));
		allChampions[53] = (new ChampionAttributes("Malzahar", MalzaharAttributes, MalzaharPositions));
		allChampions[54] = (new ChampionAttributes("Maokai", MaokaiAttributes, MaokaiPositions));
		allChampions[55] = (new ChampionAttributes("Master Yi", MasterYiAttributes, MasterYiPositions));
		allChampions[56] = (new ChampionAttributes("Miss Fortune", MissFortuneAttributes, MissFortunePositions));
		allChampions[57] = (new ChampionAttributes("Mordekaiser", MordekaiserAttributes, MordekaiserPositions));
		allChampions[58] = (new ChampionAttributes("Morgana", MorganaAttributes, MorganaPositions));
		allChampions[59] = (new ChampionAttributes("Nami", NamiAttributes, NamiPositions));
		allChampions[60] = (new ChampionAttributes("Nasus", NasusAttributes, NasusPositions));
		allChampions[61] = (new ChampionAttributes("Nautilus", NautilusAttributes, NautilusPositions));
		allChampions[62] = (new ChampionAttributes("Nidalee", NidaleeAttributes, NidaleePositions));
		allChampions[63] = (new ChampionAttributes("Nocturne", NocturneAttributes, NocturnePositions));
		allChampions[64] = (new ChampionAttributes("Nunu", NunuAttributes, NunuPositions));
		allChampions[65] = (new ChampionAttributes("Olaf", OlafAttributes, OlafPositions));
		allChampions[66] = (new ChampionAttributes("Orianna", OriannaAttributes, OriannaPositions));
		allChampions[67] = (new ChampionAttributes("Pantheon", PantheonAttributes, PantheonPositions));
		allChampions[68] = (new ChampionAttributes("Poppy", PoppyAttributes, PoppyPositions));
		allChampions[69] = (new ChampionAttributes("Quinn", QuinnAttributes, QuinnPositions));
		allChampions[70] = (new ChampionAttributes("Rammus", RammusAttributes, RammusPositions));
		allChampions[71] = (new ChampionAttributes("Renekton", RenektonAttributes, RenektonPositions));
		allChampions[72] = (new ChampionAttributes("Rengar", RengarAttributes, RengarPositions));
		allChampions[73] = (new ChampionAttributes("Riven", RivenAttributes, RivenPositions));
		allChampions[74] = (new ChampionAttributes("Rumble", RumbleAttributes, RumblePositions));
		allChampions[75] = (new ChampionAttributes("Ryze", RyzeAttributes, RyzePositions));
		allChampions[76] = (new ChampionAttributes("Sejuani", SejuaniAttributes, SejuaniPositions));
		allChampions[77] = (new ChampionAttributes("Shaco", ShacoAttributes, ShacoPositions));
		allChampions[78] = (new ChampionAttributes("Shen", ShenAttributes, ShenPositions));
		allChampions[79] = (new ChampionAttributes("Shyvana", ShyvanaAttributes, ShyvanaPositions));
		allChampions[80] = (new ChampionAttributes("Singed", SingedAttributes, SingedPositions));
		allChampions[81] = (new ChampionAttributes("Sion", SionAttributes, SionPositions));
		allChampions[82] = (new ChampionAttributes("Sivir", SivirAttributes, SivirPositions));
		allChampions[83] = (new ChampionAttributes("Skarner", SkarnerAttributes, SkarnerPositions));
		allChampions[84] = (new ChampionAttributes("Sona", SonaAttributes, SonaPositions));
		allChampions[85] = (new ChampionAttributes("Soraka", SorakaAttributes, SorakaPositions));
		allChampions[86] = (new ChampionAttributes("Swain", SwainAttributes, SwainPositions));
		allChampions[87] = (new ChampionAttributes("Syndra", SyndraAttributes, SyndraPositions));
		allChampions[88] = (new ChampionAttributes("Talon", TalonAttributes, TalonPositions));
		allChampions[89] = (new ChampionAttributes("Taric", TaricAttributes, TaricPositions));
		allChampions[90] = (new ChampionAttributes("Teemo", TeemoAttributes, TeemoPositions));
		allChampions[91] = (new ChampionAttributes("Thresh", ThreshAttributes, ThreshPositions));
		allChampions[92] = (new ChampionAttributes("Tristana", TristanaAttributes, TristanaPositions));
		allChampions[93] = (new ChampionAttributes("Trundle", TrundleAttributes, TrundlePositions));
		allChampions[94] = (new ChampionAttributes("Tryndamere", TryndamereAttributes, TryndamerePositions));
		allChampions[95] = (new ChampionAttributes("Twisted Fate", TwistedFateAttributes, TwistedFatePositions));
		allChampions[96] = (new ChampionAttributes("Twitch", TwitchAttributes, TwitchPositions));
		allChampions[97] = (new ChampionAttributes("Udyr", UdyrAttributes, UdyrPositions));
		allChampions[98] = (new ChampionAttributes("Urgot", UrgotAttributes, UrgotPositions));
		allChampions[99] = (new ChampionAttributes("Varus", VarusAttributes, VarusPositions));
		allChampions[100] = (new ChampionAttributes("Vayne", VayneAttributes, VaynePositions));
		allChampions[101] = (new ChampionAttributes("Veigar", VeigarAttributes, VeigarPositions));
		allChampions[102] = (new ChampionAttributes("Vel Koz", VelKozAttributes, VelkozPositions));
		allChampions[103] = (new ChampionAttributes("Vi", ViAttributes, ViPositions));
		allChampions[104] = (new ChampionAttributes("Viktor", ViktorAttributes, ViktorPositions));
		allChampions[105] = (new ChampionAttributes("Vladimir", VladimirAttributes, VladimirPositions));
		allChampions[106] = (new ChampionAttributes("Volibear", VolibearAttributes, VolibearPositions));
		allChampions[107] = (new ChampionAttributes("Warwick", WarwickAttributes, WarwickPositions));
		allChampions[108] = (new ChampionAttributes("Wukong", WukongAttributes, WukongPositions));
		allChampions[109] = (new ChampionAttributes("Xerath", XerathAttributes, XerathPositions));
		allChampions[110] = (new ChampionAttributes("Xin Zhao", XinZhaoAttributes, XinZhaoPositions));
		allChampions[111] = (new ChampionAttributes("Yasuo", YasuoAttributes, YasuoPositions));
		allChampions[112] = (new ChampionAttributes("Yorick", YorickAttributes, YorickPositions));
		allChampions[113] = (new ChampionAttributes("Zac", ZacAttributes, ZacPositions));
		allChampions[114] = (new ChampionAttributes("Zed", ZedAttributes, ZedPositions));
		allChampions[115] = (new ChampionAttributes("Ziggs", ZiggsAttributes, ZiggsPositions));
