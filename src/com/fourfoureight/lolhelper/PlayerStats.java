...
public class PlayerStats extends ActionBarActivity
{
	String results[];
	EditText edit1;
	TextView rankedHeader, normalHeader, dominionHeader, normal3v3Header, ofaHeader, fb1Header, fb2Header, hexHeader,
			urfHeader;
	...
	boolean hasPlayedRanked5v5 = false, hasPlayedNormal5v5 = false, hasPlayedDominion = false,
	...
	// Automatically called when the activity starts. Initializes stats array, sets the layout of the page and
	// establishes the touch event listeners.
	/*
	...
	// Creates an instance of StatsPull and retrieves the stats summary for the given summoner and writes it to the text
	// views
	 ...
	 * Parameter: none
	 * Returns: none
	 * Description: Creates an instance of StatsPull and retrieves the stats summary for the given summoner and writes
	 * them to the text views
	 */
